#include "troll-cpp/look_up_tables.hpp"
#include "look_up_tables_cache.hpp"
...
bool SaveLookUpTablesToCache(Context &ctx)
{
    ...
    if (!std::filesystem::exists(cacheDir))
    {
        ...
        {
            LOG_CERR << "Failed to create directory: " << cacheDir << "\n";
            return false;
        }
    }
    ...
    if (!out)
    {
        LOG_CERR << "Cannot open LUT cache for writing: " << LUT_CACHE_FILE << "\n";
        return false;
    }
