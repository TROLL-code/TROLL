...
void ReadInputDailyvar()
{
    ...
    cout << endl
         << "Reading in file: " << inputfile_daytimevar << endl;
...
{
    cout << endl
         << "Reading in file: " << inputfile_climate << endl;
...
{
    cout << endl
         << "Reading in file: " << inputfile_soil << endl;
    ...
    if (InSoil)
    {
        ...
        if (NULL == (layer_depth = new float[nblayers_soil]))
            cerr << "!!! Mem_Alloc layer_depth" << endl;
        ...
        if (NULL == (Max_SWC = new float[nblayers_soil]))
            cerr << "!!! Mem_Alloc Max_SW" << endl;
        if (NULL == (FC_SWC = new float[nblayers_soil]))
        ...
        if (NULL == (Min_SWC = new float[nblayers_soil]))
            cerr << "!!! Mem_Alloc Max_SW" << endl;
        ...
        if (ctx.opt._WATER_RETENTION_CURVE == 1)
        {
            if (NULL == (a_vgm = new float[nblayers_soil]))
                cerr << "!!! Mem_Alloc a_vgm" << endl;
            if (NULL == (b_vgm = new float[nblayers_soil]))
                cerr << "!!! Mem_Alloc b_vgm" << endl;
            if (NULL == (c_vgm = new float[nblayers_soil]))
                cerr << "!!! Mem_Alloc c_vgm" << endl;
            if (NULL == (m_vgm = new float[nblayers_soil]))
                cerr << "!!! Mem_Alloc m_vgm" << endl;
        ...
        {
            if (NULL == (phi_e = new float[nblayers_soil]))
                cerr << "!!! Mem_Alloc phi_e" << endl;
            if (NULL == (b = new float[nblayers_soil]))
...
{
    cout << endl
         << "Reading in file: " << inputfile_pointcloud << endl;
...
void ReadInputInventory()
{
    ...
    cout << endl
         << "Reading in file: " << inputfile_inventory << endl;
    ...
    cout << endl
         << "Reading in file: " << inputfile_SWC << endl;
...
#ifdef WATER
    if (NULL == (SWC3D = new float *[nblayers_soil]))
        cerr << "!!! Mem_Alloc\n";
    if (NULL == (soil_phi3D = new float *[nblayers_soil]))
        cerr << "!!! Mem_Alloc\n";
    if (NULL == (Ks = new float *[nblayers_soil]))
        cerr << "!!! Mem_Alloc\n";
    if (NULL == (KsPhi = new float *[nblayers_soil]))
        cerr << "!!! Mem_Alloc\n";
    // if (NULL==(KsPhi2=new float*[nblayers_soil])) cerr<<"!!! Mem_Alloc\n";
    if (NULL == (Transpiration = new float *[nblayers_soil]))
        cerr << "!!! Mem_Alloc\n";
    for (int l = 0; l < nblayers_soil; l++)
    {
